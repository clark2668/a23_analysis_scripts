...
do
	...
	new_save='/data/user/brianclark/A23Diffuse/100pct/ProcessedFile/A'$station'/by_config/c'$config'/'$base_name
	old_full_name=/data/user/brianclark/A23Diffuse/100pct/ProcessedFile/$f
	echo $new_save
