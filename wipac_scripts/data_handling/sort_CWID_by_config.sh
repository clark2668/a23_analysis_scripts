...
do
	...
	new_save='/data/user/brianclark/A23Diffuse/100pct/CWID/A'$station'/by_config/c'$config'/'$base_name
	old_full_name=/data/user/brianclark/A23Diffuse/100pct/CWID/$f
