...
OutputDir="/data/user/brianclark/A23Diffuse/100pct_try2/CWIDTest/A${STATION}/${CONFIG}"
...
do
	...
	echo $FileTarget
	export FileTarget
	condor_submit -name doCWID_$CONFIG_file$FileNumber /home/brianclark/A23_analysis_new2/a23_analysis_scripts/wipac_scripts/100pct/step2c-check_cw/job.submit.A23.CWID.test
