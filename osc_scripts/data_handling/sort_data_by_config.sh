...
do
	...
	# new_save='/fs/scratch/PAS0654/ara/10pct/RawData/A'$station'/by_config/c'$config'/'$base_name
	# old_full_name=/fs/scratch/PAS0654/ara/10pct/RawData/$f
