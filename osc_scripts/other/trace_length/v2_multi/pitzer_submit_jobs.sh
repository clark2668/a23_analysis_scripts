...
OutputDir="/fs/project/PAS0654/ARA_DATA/A23/10pct/other_studies/TraceLength/A${station}/c${config}"
ErrFile="/fs/project/PAS0654/ARA_DATA/A23/10pct/other_studies/TraceLength/problems_A${station}_c${config}.txt" 
...
LaunchDir="/users/PAS0654/osu0673/A23_analysis_new2/a23_analysis_scripts/osc_scripts/other/trace_length/v2_multi"
