...
OutputDir="/users/PAS0654/osu0673/A23_analysis_new2/results/reco_vs_time_multi/A${station}/c${config}/"
readfile=../data_by_config/A${station}_c${config}_ValsFiles_owens.txt
...
LaunchDir="/users/PAS0654/osu0673/A23_analysis_new2/a23_analysis_scripts/osc_scripts/other/reco_vs_time_multi/v2_multi"
