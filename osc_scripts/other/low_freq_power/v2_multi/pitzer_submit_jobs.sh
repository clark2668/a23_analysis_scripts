...
OutputDir="/fs/scratch/PAS0654/ara/10pct/other_studies/LowFreqPower/A${station}/c${config}"
ErrFile="/fs/scratch/PAS0654/ara/10pct/LowFreqPower/problems_A${station}_c${config}.txt"
...
LaunchDir="/users/PAS0654/osu0673/A23_analysis_new2/a23_analysis_scripts/osc_scripts/other/low_freq_power/v2_multi"
