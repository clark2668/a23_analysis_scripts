...
then
	...
	readfile=../../run_diffuse/step1-make_ped_pairs/A${station}_E${energy}_sim_files.txt
...
then
	...
	readfile=../../run_diffuse/step1-make_ped_pairs/A${station}_${year}_File_Ped_Pairs.txt
fi
