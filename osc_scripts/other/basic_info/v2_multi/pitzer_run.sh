...
./pitzer_doThis.sh $STATION $F1 $TMPDIR &
declare pid_1=$!
declare F_1=$F1
./pitzer_doThis.sh $STATION $F2 $TMPDIR &
declare pid_2=$!
declare F_2=$F2
./pitzer_doThis.sh $STATION $F3 $TMPDIR &
declare pid_3=$!
declare F_3=$F3
./pitzer_doThis.sh $STATION $F4 $TMPDIR &
declare pid_4=$!
declare F_4=$F4
./pitzer_doThis.sh $STATION $F5 $TMPDIR &
declare pid_5=$!
declare F_5=$F5
