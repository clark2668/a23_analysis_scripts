...
OutputDir="/fs/project/PAS0654/ARA_DATA/A23/sim/other_studies/BasicInfo/A${station}/c${config}"
...
LaunchDir="/users/PAS0654/osu0673/A23_analysis_new2/a23_analysis_scripts/osc_scripts/other/basic_info/v2_multi"
