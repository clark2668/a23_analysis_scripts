...
#OutputDir="/fs/scratch/PAS0654/ara/10pct/other_studies/RMSvalues/A${station}/c${config}"
OutputDir="/fs/scratch/PAS0654/ara/10pct/other_studies/OffsetBlock/A${station}/c${config}"
#ErrFile="/fs/scratch/PAS0654/ara/10pct/RMSvalues/problems_A${station}_c${config}.txt"
ErrFile="/fs/scratch/PAS0654/ara/10pct/OffsetBlocks/problems_A${station}_c${config}.txt" 
...
LaunchDir="/users/PAS0654/osu0673/A23_analysis_new2/a23_analysis_scripts/osc_scripts/other/offset_block/v2_multi"
