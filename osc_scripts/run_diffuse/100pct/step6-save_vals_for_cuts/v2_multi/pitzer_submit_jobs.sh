...
then
	...
	# readfile=../data_by_config/good_A${station}_c${config}_pitzer.txt
	readfile=../data_by_config/goodredo_A${station}_c${config}_pitzer.txt
	...
	walltime=14:00:00
	ErrFile="/fs/project/PAS0654/ARA_DATA/A23/100pct/ValsForCuts/data_savevalsproblems100_A${station}_${config}_rd2.txt"
fi
