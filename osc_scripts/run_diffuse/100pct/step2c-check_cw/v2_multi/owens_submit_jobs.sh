...
then
	FilterFileDir="/fs/project/PAS0654/ARA_DATA/A23/100pct_try2/ProcessedFile/A${station}/${year}"
	OutputDir="/fs/project/PAS0654/ARA_DATA/A23/100pct_try2/CWID/A${station}/${year}"
	ErrFile="/fs/project/PAS0654/ARA_DATA/A23/100pct_try2/CWID/data_CWID_Correct_problems_A${station}_${year}_100pct.txt"
...
while read line1 && read line2 && read line3 && read line4 && read line5 && read line6 && read line7
do
