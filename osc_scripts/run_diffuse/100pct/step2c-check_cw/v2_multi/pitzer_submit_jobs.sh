...
FilterFileDir="/fs/project/PAS0654/ARA_DATA/A23/100pct/ProcessedFile/A${station}/${year}"
echo '[ Run summary directory: ' $SummaryDir ' ]'
export SummaryDir
...
then
	OutputDir="/fs/project/PAS0654/ARA_DATA/A23/100pct/CWID/A${station}/${year}"
	ErrFile="/fs/project/PAS0654/ARA_DATA/A23/100pct/CWID/data_CWIDproblems_A${station}_${year}_100pct_redo.txt"
	# readfile=../../step1-make_ped_pairs/A${station}_${year}_File_Ped_Pairs_pitzer.txt
	readfile=problems_cw_${year}.txt
...
LaunchDir="/users/PAS0654/osu0673/A23_analysis_new2/a23_analysis_scripts/osc_scripts/run_diffuse/100pct/step2c-check_cw/v2_multi"
