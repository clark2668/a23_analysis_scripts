...
then
	OutputDir="/fs/project/PAS0654/ARA_DATA/A23/CWID/A${station}/${year}"
	ErrFile="/fs/project/PAS0654/ARA_DATA/A23/CWID/data_CWIDproblems_A${station}_${year}_100pct.txt"
