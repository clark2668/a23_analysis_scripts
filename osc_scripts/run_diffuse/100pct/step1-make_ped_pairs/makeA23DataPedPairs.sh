...
then
	...
	then
		...
		done < ../step0-make_run_list/A2List_10in10_2013.txt
	elif [ $station -eq 3 ]
	then
		while read line
		do
...
then
	...
	then
		...
		done < ../step0-make_run_list/A2List_10in10_2014.txt
	elif [ $station -eq 3 ]
	then
		while read line
		do
...
then
	...
	then
		...
		done < ../step0-make_run_list/A2List_10in10_2015.txt
	elif [ $station -eq 3 ]
	then
		while read line
		do
...
then
	...
	then
		...
		done < ../step0-make_run_list/A2List_10in10_2016.txt
	elif [ $station -eq 3 ]
	then
		while read line
		do
