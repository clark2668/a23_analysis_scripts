...
FilterDir="/fs/project/PAS0654/ARA_DATA/A23/100pct/ProcessedFile/A${station}/${year}"
...
then
	OutputDir="/fs/project/PAS0654/ARA_DATA/A23/100pct/ProcessedFile/A${station}/${year}/special"
	ErrFile="/fs/project/PAS0654/ARA_DATA/A23/100pct/ProcessedFile/data_filterproblems100_A${station}_${year}.txt"
	readfile=../../step1-make_ped_pairs/A${station}_${year}_File_Ped_Pairs_owens.txt
	readfile=problems_reco_${year}.txt
...
LaunchDir="/users/PAS0654/osu0673/A23_analysis_new2/a23_analysis_scripts/osc_scripts/run_diffuse/100pct/step4-reco/v2_multi_owens"
