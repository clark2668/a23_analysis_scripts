...
FilterDir="/fs/project/PAS0654/ARA_DATA/A23/100pct_try2/ProcessedFile/A${station}/${year}"
...
then
	...
	# walltime=00:10:00
	echo "why are you running 100pct code over simulation? I'm quitting..."
	exit 1
