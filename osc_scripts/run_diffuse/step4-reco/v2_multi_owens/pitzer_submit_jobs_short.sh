...
then
	...
	ErrFile="/fs/project/PAS0654/ARA_DATA/A23/10pct_redo/ProcessedFile/data_recoproblems_A${station}_${year}_R${RadiusBin}_rd2.txt"
	readfile=../../make_run_lists/A${station}List_1in10_${year}_bySize_pitzer.txt
	readfile=/fs/project/PAS0654/ARA_DATA/A23/10pct_redo/ProcessedFile/data_recoproblems_A${station}_${year}_R${RadiusBin}.txt
	walltime=36:00:00
