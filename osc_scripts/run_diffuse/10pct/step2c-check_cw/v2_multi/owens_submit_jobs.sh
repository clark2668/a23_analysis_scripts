...
then
	...
	readfile=A${station}_${year}_cwredo_owens.txt
...
LaunchDir="/users/PAS0654/osu0673/A23_analysis_new2/a23_analysis_scripts/osc_scripts/run_diffuse/10pct/step2c-check_cw/v2_multi"
