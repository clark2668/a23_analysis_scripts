...
then
	OutputDir="/fs/project/PAS0654/ARA_DATA/A23/10pct_verify/ProcessedFile/A${station}/${year}"
	ErrFile="/fs/project/PAS0654/ARA_DATA/A23/10pct_verify/ProcessedFile/data_filterproblems100_A${station}_${year}.txt"
