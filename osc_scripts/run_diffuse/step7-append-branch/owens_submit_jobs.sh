...
then
	...
	readfile=sim_A${station}_c${config}_savevals.txt
	err_out_location=/fs/project/PAS0654/ARA_DATA/A23/sim/err_out_logs
	ErrFile="/fs/project/PAS0654/ARA_DATA/A23/sim/ValsForCuts/problems_addBranchGlitch_A${station}_c${config}_E${energy}_rd1.txt"
	walltime=00:10:00
...
then
	...
	readfile=A${station}_c${config}_savevals.txt
	# readfile=/fs/project/PAS0654/ARA_DATA/A23/10pct_redo/ValsForCuts_v2/problems_addbranch_A${station}_c${config}_rd1.txt
	err_out_location=/fs/project/PAS0654/ARA_DATA/A23/10pct_redo/err_out_logs
	ErrFile="/fs/project/PAS0654/ARA_DATA/A23/10pct_redo/ValsForCuts_v2/problems_addbranchBlast2_A${station}_c${config}_rd1.txt"
	walltime=02:00:00
fi
...
LaunchDir="/users/PAS0654/osu0673/A23_analysis_new2/a23_analysis_scripts/osc_scripts/run_diffuse/step7-append-branch"
